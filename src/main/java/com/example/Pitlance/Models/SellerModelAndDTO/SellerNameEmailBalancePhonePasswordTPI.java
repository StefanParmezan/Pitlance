...
public record SellerNameEmailBalancePhonePasswordTPI(String companyName, String sellerName, String sellerLastName, String email, int phoneNumber, String taxPayerId, BigDecimal balance, String password) {
